...
weights_lb <- weights * 2.2 # Your code here
...
selected_weights <- weights_lb[c(3, 5)] # Your code here
...
avg_weight <- mean(weights_lb) # Your code here
...
heavy_count <- sum(weights > 60) # Your code here